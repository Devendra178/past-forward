                     ...
                     <>
                        {isMobile ? (
                            <div className="w-full max-w-sm flex-1 overflow-y-auto mt-4 space-y-8 p-4">
                                {DECADES.map((decade) => {
                                    {/* Fix: Use non-null assertion as `generatedImages` is guaranteed to have an entry for each decade. */}
                                    const imageForDecade = generatedImages[decade]!;
                                    return (
                                        <div key={decade} className="flex justify-center">
                                            <PolaroidCard
                                                caption={decade}
                                                status={imageForDecade.status}
                                                imageUrl={imageForDecade.url}
                                                error={imageForDecade.error}
